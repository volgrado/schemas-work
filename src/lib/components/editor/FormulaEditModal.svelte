  ...
  const updatePreview = debounce(() => {
    if (previewEl) {
      try {
        ...
        // FIX: Use $t to access the function inside the store.
  ...
  <div class="formula-editor-grid">
    ...
    <div class="right-pane">
      ...
      <div class="help-pane">
        ...
        <ul>
          <li>
            {$t('formula_editor.help.fractions')}
            <code>{String.raw`\frac{a}{b}`}</code>
          </li>
          <li>{$t('formula_editor.help.superscript')} <code>x^2</code></li>
          <li>{$t('formula_editor.help.subscript')} <code>H_2O</code></li>
          <li>
            {$t('formula_editor.help.square_root')}
            <code>{String.raw`\sqrt{x}`}</code>
          </li>
          <li>
            {$t('formula_editor.help.summation')}
            <code>{String.raw`\sum_{i=1}^n`}</code>
          </li>
          <li>
            {$t('formula_editor.help.greek_letters')}
            <code>{String.raw`\alpha, \beta, \gamma`}</code>
          </li>
        </ul>
      </div>
    </div>

...
1.  **Global vs. Module**:
    -   If a service is used by _only one_ module, place it in `src/lib/modules/[module]/infra`.
...
-   **Legacy Stores**: Avoid `writable` / `readable` unless interfacing with libraries that require them.
